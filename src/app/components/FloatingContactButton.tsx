  ...
  return (
    <Link to="/contact#contact-form" aria-label="Contact us">
      ...
      >
        ...
        {/* Hover effect */}
        <div className="absolute inset-0 bg-gradient-to-br from-green-400/30 to-green-500/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 shell-float-y-slow" />
        ...
        {/* Glow ring */}
        <div className="absolute -inset-1 bg-gradient-to-r from-green-400 to-green-500 rounded-2xl blur-lg opacity-0 group-hover:opacity-60 -z-10 shell-pulse-scale" />

        {/* Tooltip */}
        <div className="absolute right-full mr-3 px-3 py-1.5 bg-surface-raised/90 backdrop-blur-md border border-white/10 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
