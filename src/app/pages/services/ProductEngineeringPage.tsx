...
import { ArrowLeft, Code2, Smartphone, Database, Cloud, CreditCard } from "lucide-react";
...
// Service offerings within Product Builder
const productServices = [
  {
    id: "custom-software",
    title: "Custom Software",
    icon: Code2,
    purpose: "Build tailored systems aligned with your business logic.",
    whenNeeded: ["Unique workflows not supported by off-the-shelf software", "Automating business processes"],
    capabilities: [
      "Custom architecture and system design",
      "Integration with internal tools",
      "Feature implementation",
    ],
    outcomes: ["Scalable, flexible solutions", "Streamlined operations", "Product aligned with real business needs"],
  },
  {
    id: "app-engineering",
    title: "App Engineering",
    icon: Smartphone,
    purpose: "Develop high-performance applications for iOS, Android, and web.",
    whenNeeded: ["Launching mobile or web applications", "Updating existing apps for performance or scalability"],
    capabilities: [
      "Native and cross-platform development",
      "UI integration and API connectivity",
      "Performance optimization",
    ],
    outcomes: ["Fast, responsive apps", "Consistent user experience", "Reliable multi-platform performance"],
  },
  {
    id: "backend-api",
    title: "Backend & API Systems",
    icon: Database,
    purpose: "Build secure, fast, and maintainable backend and API services.",
    whenNeeded: ["Supporting data-heavy applications", "Integrating multiple services or systems"],
    capabilities: ["API design and documentation", "Database architecture", "Server-side logic and security"],
    outcomes: ["Predictable system behavior", "Easier integrations", "Reduced technical debt"],
  },
  {
    id: "cloud-infrastructure",
    title: "Cloud Infrastructure",
    icon: Cloud,
    purpose: "Create stable, scalable environments for your product.",
    whenNeeded: ["Scaling products with traffic growth", "Migrating to cloud solutions"],
    capabilities: ["Cloud deployment and configuration", "Performance monitoring", "Disaster recovery planning"],
    outcomes: ["High availability and uptime", "Easy scalability", "Reliable infrastructure"],
  },
  {
    id: "payment-subscription",
    title: "Payment, Subscription & App Support",
    icon: CreditCard,
    purpose: "Integrate payments, subscriptions, logistics, and app analytics.",
    whenNeeded: ["Monetizing apps or platforms", "Launching e-commerce or subscription models"],
    capabilities: [
    ...
    outcomes: ["Smooth payment and subscription flows", "Real-time analytics", "Better product launch experience"],
  },
];
...
export default function ProductEngineeringPage() {
  return (
    <>
      <SEO
        title="Product Builder - Zaxa Studio"
        description="The Product Builder ensures your product's core systems are reliable, scalable, and ready for business growth. From backend to cloud infrastructure, it supports real business logic and smooth operation."
      />
        ...
        <div className="relative w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-16 md:pt-32 pb-12 md:pb-24">
          ...
          <div className="max-w-[1400px] mx-auto">
            ...
            >
              ...
              >
                <Code2 className="w-full h-full" strokeWidth={0.5} />
              </motion.div>
              ...
              <div className="max-w-5xl relative">
                ...
                >
                  ...
                  <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-[#1DCD9F]/20 via-[#5FEFBF]/10 to-transparent border border-[#1DCD9F]/30 flex items-center justify-center overflow-hidden group backdrop-blur-sm">
                    ...
                    <Code2 className="relative w-10 h-10 text-[#1DCD9F]" strokeWidth={1.5} />
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    The Product Builder ensures your product's core systems are reliable, scalable, and ready for
                    business growth. From backend to cloud infrastructure, it supports real business logic and smooth
                    operation.
                  </p>
                </motion.div>
                    ...
                    <div className="relative">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {[
                          ...
                          "Scaling or upgrading existing systems",
                          "Integrating payment, subscription, or logistics systems",
                          "Releasing apps to stores with analytics",
                        ].map((item, idx) => (
                          <motion.div
                            key={idx}
                  ...
                  <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                    <div className="flex-1">
                      ...
                      <p
                        ...
                        style={{ fontFamily: "'Inter', sans-serif" }}
                      >
                        Transform your ideas into high-performance systems built to last and grow with your business.
                      </p>
                    </div>
