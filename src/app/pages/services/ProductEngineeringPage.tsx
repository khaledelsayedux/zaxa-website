...
const productServices = [
  {
    ...
    whenNeeded: [
      'Unique workflows not supported by off-the-shelf software',
    ...
    outcomes: [
      ...
      'Product aligned with real business needs'
    ]
  },
  {
    id: 'app-engineering',
    ...
    whenNeeded: [
      'Launching mobile or web applications',
      'Updating existing apps for performance or scalability'
    ],
    capabilities: [
    ...
    outcomes: [
      ...
      'Reliable multi-platform performance'
    ]
  },
  {
    id: 'backend-api',
    ...
    whenNeeded: [
      ...
      'Integrating multiple services or systems'
    ],
    capabilities: [
  ...
  },
  {
    ...
    whenNeeded: [
      'Scaling products with traffic growth',
  ...
  },
  {
    ...
    whenNeeded: [
      'Monetizing apps or platforms',
      'Launching e-commerce or subscription models'
    ],
    capabilities: [
    ...
    outcomes: [
      'Smooth payment and subscription flows',
      'Real-time analytics',
      'Better product launch experience'
    ]
  }
];
              ...
              <div className="max-w-5xl relative">
                ...
                >
                  ...
                  <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-green-400/20 via-green-300/10 to-transparent border border-green-400/30 flex items-center justify-center overflow-hidden group backdrop-blur-sm">
                    ...
                    <Code2 className="relative w-10 h-10 text-green-400" strokeWidth={1.5} />
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    The Product Builder ensures your product's core systems are reliable, scalable, and ready for business growth. From backend to cloud infrastructure, it supports real business logic and smooth operation.
                  </p>
                </motion.div>
