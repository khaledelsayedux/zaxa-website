...
import { ArrowLeft, Box, Layers, Eye, Lightbulb, Building2 } from 'lucide-react';
...
// Service offerings within Experiential & Spatial Design
const spatialServices = [
  {
    id: '3d-booth-event-design',
    title: '3D Booth & Event Design',
    icon: Box,
    purpose: 'Design engaging exhibition booths and event spaces that attract and retain attention.',
    whenNeeded: [
      'Launching products or services at trade shows or events',
      'Needing a memorable presence in physical spaces',
      'Showcasing complex concepts visually'
    ],
    capabilities: [
      'Booth layout and spatial design',
      'Interactive visual displays',
      'Visual storytelling and branding integration',
      'Material and structure planning'
    ],
    outcomes: [
      'Increased foot traffic and engagement',
      'Memorable brand impression',
      'Clearer communication of product/service value'
    ]
  },
  {
    ...
    icon: Lightbulb,
    purpose: 'Create physical touchpoints that allow users to interact and experience the brand or product directly.',
    whenNeeded: [
      'Wanting hands-on engagement with products',
      'Highlighting product features through interaction',
      'Making events or spaces more dynamic and memorable'
    ],
    capabilities: [
      'Physical interface design',
      'Touchpoints and user interaction mapping',
      'Integration with product messaging or story',
      'Feedback tracking for user interaction'
    ],
    outcomes: [
      'Higher user engagement and interest',
      'Improved product understanding',
      'Enhanced experiential brand recall'
    ]
  },
  {
    id: 'environmental-branding',
    title: 'Environmental Branding',
    icon: Building2,
    purpose: 'Apply visual and experiential branding to spaces like showrooms, offices, or retail locations.',
    whenNeeded: [
      'Establishing a consistent physical brand presence',
      'Enhancing customer or visitor experience',
      'Launching new locations or renovating existing ones'
    ],
    capabilities: [
      'Visual identity application to spaces',
      'Wayfinding and signage design',
      'Interior branding elements design',
      'Coordinating with spatial design and materials'
    ],
    outcomes: [
      'Cohesive brand experience',
      'Improved visitor understanding and navigation',
      'Stronger brand recognition in physical spaces'
    ]
  }
];

export default function ExperientialSpatialPage() {
  return (
    <>
      <SEO 
        title="Experiential & Spatial Design - Zaxa Studio"
        description="Transform spaces into immersive experiences that communicate brand value, educate users, and drive interaction."
      />
        ...
        <div className="relative w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-32 pb-24">
          ...
          <div className="max-w-[1400px] mx-auto">
            ...
            >
              ...
              >
                <Box className="w-full h-full" strokeWidth={0.5} />
              </motion.div>
              ...
              <div className="max-w-5xl relative">
                ...
                >
                  ...
                  <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-green-400/20 via-green-300/10 to-transparent border border-green-400/30 flex items-center justify-center overflow-hidden group backdrop-blur-sm">
                    ...
                    <Box className="relative w-10 h-10 text-green-400" strokeWidth={1.5} />
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    Transform spaces into immersive experiences that communicate brand value, educate users, and drive interaction.
                  </p>
                </motion.div>
                    ...
                    <div className="relative">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {[
                          ...
                          'Designing exhibition booths or installations',
                          'Enhancing showrooms or retail spaces'
                        ].map((item, idx) => (
                          <motion.div
                            key={idx}
            ...
            >
              ...
              <div className="flex items-center gap-6 mb-12">
                <div className="flex-shrink-0">
                  ...
                  <p 
                    ...
                    style={{ fontFamily: "'Inter', sans-serif" }}
                  >
                    Spatial and experiential design capabilities
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-16">
                {spatialServices.map((service, idx) => (
                  <motion.div
                    key={service.id}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                    <div className="flex-1">
                      <h3 
                        ...
                        style={{ fontFamily: "'Inter Tight', sans-serif" }}
                      >
                        Ready to Bring Ideas to Life in 3D
                      </h3>
                      <p 
                        className="text-base md:text-lg text-white/60 max-w-xl"
                        style={{ fontFamily: "'Inter', sans-serif" }}
                      >
                        Transform spaces, booths, and installations into immersive, interactive experiences that impress and engage.
                      </p>
                    </div>
