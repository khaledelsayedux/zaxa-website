...
const brandServices = [
  ...
  },
  {
    ...
    whenNeeded: [
      'Creating website or app content',
  ...
  },
  {
    ...
    whenNeeded: [
      'Launching product campaigns',
      'Running email or ad campaigns',
      'Engaging social audiences'
    ],
    capabilities: [
      'Funnel-focused copywriting',
      'Social media posts',
      'Ads and retargeting copy'
    ],
    outcomes: [
  ...
  },
  {
    ...
    whenNeeded: [
      ...
      'Promoting social or product content',
    ...
    <>
      ...
      <div className="relative min-h-screen bg-background">
        ...
        <div className="relative w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-32 pb-24">
          ...
          <div className="max-w-[1400px] mx-auto">{/* Changed from max-w-7xl to max-w-[1400px] for better consistency */}
            {/* Back Button */}
            <motion.div
            ...
            >
              ...
              <div className="max-w-5xl relative">
                ...
                >
                  ...
                  <div className="absolute inset-0 w-20 h-20 rounded-2xl bg-green-400/20 blur-2xl" />
                  
                  {/* Icon container */}
                  <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-green-400/20 via-green-400/10 to-transparent border border-green-400/30 flex items-center justify-center overflow-hidden group backdrop-blur-sm">
                    ...
                    <Radio className="relative w-10 h-10 text-green-400" strokeWidth={1.5} />
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    The Brand Builder helps your product communicate its value, build trust, and engage the right audience. From visual identity to marketing campaigns, it ensures your brand is consistent, compelling, and optimized for growth.
                  </p>
                </motion.div>
                  ...
                  <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                    <div className="flex-1">
                      ...
                      <p 
                        ...
                        style={{ fontFamily: "'Inter', sans-serif" }}
                      >
                        Craft messaging, campaigns, and visuals that communicate value, build trust, and grow your audience.
                      </p>
                    </div>
