...
import { ArrowLeft, Palette, Video, Image, Film, Radio, PenTool, Camera } from "lucide-react";
...
// Service offerings within Brand Builder
const brandServices = [
  {
    id: "brand-systems",
    title: "Brand Systems & Visual Identity",
    icon: Palette,
    purpose: "Create a complete visual identity and consistent brand assets.",
    whenNeeded: [
      "Launching a new brand or product",
      "Rebranding or updating existing visuals",
    ...
    outcomes: ["Cohesive brand presence", "Recognizable identity", "Strong visual appeal"],
  },
  {
    id: "strategic-copywriting",
    title: "Strategic Copywriting",
    icon: PenTool,
    purpose: "Align messaging and copy with product and brand strategy.",
    whenNeeded: ["Creating website or app content", "Developing brand messaging", "Writing marketing copy"],
    capabilities: ["Messaging frameworks", "Product descriptions and website copy", "Brand story and tone of voice"],
    outcomes: ["Clear communication of value", "Consistent messaging across channels", "Engaging brand story"],
  },
  {
    id: "marketing-campaigns",
    title: "Marketing Copywriting Campaigns",
    icon: Radio,
    purpose: "Develop targeted campaigns for social media, funnels, and ads.",
    whenNeeded: ["Launching product campaigns", "Running email or ad campaigns", "Engaging social audiences"],
    capabilities: ["Funnel-focused copywriting", "Social media posts", "Ads and retargeting copy"],
    outcomes: ["Improved conversions", "Higher engagement", "Consistent campaign messaging"],
  },
  {
    id: "product-marketing",
    title: "Product Marketing Strategy",
    icon: Film,
    purpose: "Plan positioning, messaging, and go-to-market execution.",
    whenNeeded: [
      "Launching new products or features",
      "Entering new markets",
      "Aligning marketing with business goals",
    ],
    capabilities: ["Positioning and messaging strategy", "Campaign planning", "Go-to-market roadmaps"],
    outcomes: ["Product-market fit clarity", "Effective launch campaigns", "Increased reach and awareness"],
  },
  {
    id: "digital-media",
    title: "Digital & Media Services",
    icon: Video,
    purpose: "Execute marketing, media, and content strategies for engagement and awareness.",
    whenNeeded: ["Running paid campaigns", "Promoting social or product content", "Generating audience growth"],
    capabilities: [
    ...
    outcomes: ["Higher engagement and reach", "Optimized campaigns", "Consistent brand visibility"],
  },
  {
    id: "photography-videography",
    title: "Photography & Videography",
    icon: Camera,
    purpose: "Create high-quality visual content that showcases your product, brand, and experience.",
    whenNeeded: [
      "Launching a new product or campaign",
      "Building marketing or social media content",
      "Creating website or advertising visuals",
      "Showcasing products, teams, spaces, or events",
    ],
    capabilities: [
      "Product photography",
    ...
    outcomes: [
      ...
      "High-quality content for marketing channels",
...
export default function BrandMarketingPage() {
  return (
    <>
      <SEO
        title="Brand Builder - Zaxa Studio"
        description="The Brand Builder helps your product communicate its value, build trust, and engage the right audience through visual identity, content strategy, and marketing campaigns."
      />
      ...
      <div className="relative min-h-screen bg-[#000000]">
        ...
        <div className="relative w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-16 md:pt-32 pb-12 md:pb-24">
          ...
          <div className="max-w-[1400px] mx-auto">
            {/* Changed from max-w-7xl to max-w-[1400px] for better consistency */}
            {/* Back Button */}
            <motion.div
            ...
            >
              ...
              >
                <Radio className="w-full h-full" strokeWidth={0.5} />
              </motion.div>
              ...
              <div className="max-w-5xl relative">
                ...
                >
                  ...
                  <div className="absolute inset-0 w-20 h-20 rounded-2xl bg-[#1DCD9F]/20 blur-2xl" />

                  {/* Icon container */}
                  <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-[#1DCD9F]/20 via-[#1DCD9F]/10 to-transparent border border-[#1DCD9F]/30 flex items-center justify-center overflow-hidden group backdrop-blur-sm">
                    ...
                    <Radio className="relative w-10 h-10 text-[#1DCD9F]" strokeWidth={1.5} />
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    The Brand Builder helps your product communicate its value, build trust, and engage the right
                    audience. From visual identity to marketing campaigns, it ensures your brand is consistent,
                    compelling, and optimized for growth.
                  </p>
                </motion.div>
                  ...
                  <div className="relative p-10 rounded-2xl bg-gradient-to-br from-white/[0.08] via-white/[0.04] to-white/[0.02] border border-white/10 backdrop-blur-sm overflow-hidden group-hover:border-[#1DCD9F]/50 group-hover:bg-gradient-to-br group-hover:from-[#1DCD9F]/10 group-hover:via-[#1DCD9F]/5 group-hover:to-transparent transition-all duration-500">
                    ...
                    <div className="relative">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {[
                          "Launching a new brand or product",
                          "Updating or revamping an existing brand",
                          "Running marketing campaigns or product launches",
              ...
              <div className="flex items-center gap-6 mb-12">
                <div className="flex-shrink-0">
                  ...
                  <p className="text-sm text-white/50 mt-2" style={{ fontFamily: "'Inter', sans-serif" }}>
                    Comprehensive brand and marketing capabilities
                  </p>
                </div>
                  ...
                  <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                    <div className="flex-1">
                      ...
                      <p
                        ...
                        style={{ fontFamily: "'Inter', sans-serif" }}
                      >
                        Craft messaging, campaigns, and visuals that communicate value, build trust, and grow your
                        audience.
                      </p>
                    </div>
