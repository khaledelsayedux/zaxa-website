...
const securityServices = [
  {
    ...
    whenNeeded: ["Preventing security breaches", "Ensuring stable operations"],
    capabilities: ["System hardening", "Vulnerability scanning", "Security testing"],
    outcomes: ["Reduced risk", "Safer user experience"],
  },
  {
    id: "cybersecurity",
    title: "Cybersecurity",
    ...
    whenNeeded: ["Products with sensitive information", "Compliance with data protection standards"],
    capabilities: ["Network and data security", "Access controls", "Threat detection"],
    outcomes: ["Protected data", "Reduced security incidents"],
  },
  {
    id: "legal-compliance",
    ...
    whenNeeded: ["Handling user data", "Launching products with legal requirements"],
    capabilities: ["Privacy and security consulting", "Intellectual property guidance"],
    outcomes: ["Regulatory compliance", "Risk reduction"],
  },
  {
    id: "chat-support",
    ...
    whenNeeded: ["Products needing customer support", "Automated or human assistance for users"],
    capabilities: ["Chatbot integration", "Human support handling", "Support workflows"],
    outcomes: ["Improved customer satisfaction", "Efficient support operations"],
  },
];
            ...
            >
              ...
              <div className="max-w-5xl relative">
                ...
                >
                  ...
                  >
                    The Security Builder ensures your product and business are protected from risk, while maintaining
